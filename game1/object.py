...
# Abstract Class
class Object(Atom):
    def __init__(self, x, y, width, height, color, isDraw = True, isDeleted = False):
    ...
    def collision(cls, game, object1, object2):
        ...
        if not isCollision: return

        collision_direction = cls.__getCollisionDirection(object1, object2)
        event = CollisionEvent(object1, object2, collision_direction, cls.reverseDirection(collision_direction))
    ...
    def __getIsCollision(object1, object2):
        ...
        if (object2Hitbox['x'] <= object1Hitbox['x'] + object1Hitbox['width'] / 2 and object2Hitbox['x'] + object2Hitbox['width'] >= object1Hitbox['x'] - object1Hitbox['width'] / 2
            and object2Hitbox['y'] <= object1Hitbox['y'] + object1Hitbox['height'] / 2 and object2Hitbox['y'] + object2Hitbox['height'] >= object1Hitbox['y'] - object1Hitbox['height'] / 2
                ):
            return True
        return False
    ...
    def __getCollisionDirection(object1, object2):
        ...
        right_distance = -(object1Hitbox['x'] - object1Hitbox['width'] - object2Hitbox['x'] - object2Hitbox['width'])
        top_distance = object1Hitbox['y'] + object1Hitbox['height'] - object2Hitbox['y']
        bottom_distance = -(object1Hitbox['y'] - object1Hitbox['height'] - object2Hitbox['y'] - object2Hitbox['height'])
